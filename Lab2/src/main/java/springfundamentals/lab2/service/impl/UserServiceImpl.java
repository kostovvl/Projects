...
public class UserServiceImpl implements UserService {
    ...
    public void registerUser(UserSetDto userSetDto) throws EntityExistsException {
        ...
        User test = this.userRepository.findByUsername(userSetDto.getUsername()).orElse(null);
        if (this.userRepository.findByUsername(userSetDto.getUsername()).orElse(null) != null) {
        ...
        if (this.userRepository.count() == 0) {
            ...
            user.setRole(Role.valueOf("SELLER"));
        }
