...
import spring.exam.domain.dto.LoggedUserDto;
...
public class UserController {
    ...
    public String loginConfirm(@Valid @ModelAttribute("userLogin")
        ...
        LoggedUserDto loggedUserDto = this.mapper.map(userDto, LoggedUserDto.class);
            session.setAttribute("user", loggedUserDto);
            session.setAttribute("id", loggedUserDto.getId());
